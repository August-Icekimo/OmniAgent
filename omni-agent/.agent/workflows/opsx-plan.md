---
description: Open a new sprint by selecting cards from ready/ and writing a sprint plan
---
...
4. **Interact with user for sprint details**
   - **Theme & Goals**: Use **AskUserQuestion tool** (open-ended): "What is this sprint's main objective and goals?"
   - **Committed Cards**: Use **AskUserQuestion tool** (multi-select) with all ready cards as options.
   - **Stretch Cards**: Use **AskUserQuestion tool** (multi-select) with remaining ready cards.
   - **Capacity**: Use **AskUserQuestion tool**: "What is the capacity for this sprint? (e.g., evenings + weekends ≈ 20h)"
   - **Out of scope**: Use **AskUserQuestion tool** (optional): "Anything explicitly out of scope?"
