...
The following legacy documentation files have been migrated to the [OpenSpec](file:///home/icekimo/gitWrk/OmniAgent/omni-agent/openspec/) structure and should no longer be used as the source of truth.
...
For current implementation details, please refer to the files in `openspec/specs/`.
For historical context on specific features, refer to the corresponding subdirectories in `openspec/changes/archive/`.
